function CreateStat(data, firstStationSelected, secondStationSelected) {
	...
	if (firstStationSelected == null && secondStationSelected == null) {
		...
		if(gare1==null){d3.selectAll("rect").style("fill","DarkOrange");}
		else if(gare2==null){d3.selectAll("rect").style("fill","#4d4dff");}  ;       
	};
};
...
function refreshWifi(div1,div2,i){ 
  ...
  var g_wifi = statG.append("g")
  
  //creation du logo & positionnement   
  // emplacement de la valeur wifi pour la gare 1
    g_wifi.append("rect")
    	.attr("id","valeur_wifi")
      .attr("y", y_divertissements)
      .attr("x", x_divertissements1)
	 	 	.style("fill",function(){if(div1[i][1]=="true"){return "#4d4dff"}
                             else{return "lightgrey"}})
    // emplacement de la valeur wifi pour la gare 2
    g_wifi.append("rect")
    	.attr("id","valeur_wifi2")
      .attr("y", y_divertissements)
      .attr("x", x_divertissements2)
	  	.style("fill",function(){if(div2[i][1]=="true"){return "DarkOrange"}
                             else{return "lightgrey"}})
...
g_wifi.append("path")
	...
	d3.selectAll("#path_wifi").attr("transform","scale(0.05) translate("+ d3.select("#valeur_wifi").attr("x")/0.0492 +","+d3.select("#valeur_wifi").attr("y")/0.0485+")")
 
}    
function refreshBaby(div1,div2,i){ 
  
  	var g_babyfoot = statG.append("g")
    // emplacement de la valeur babyfoot pour la gare 1
    g_babyfoot.append("rect")
	  .attr("id","valeur_babyfoot")
      .attr("y", y_divertissements)
      .attr("x", x_divertissements1 +(i*36)+(i*18))
	 	 	.style("fill",function(){if(div1[i][1]>0){return "#4d4dff"}
                             else{return "lightgrey"}})
    // emplacement de la valeur babyfoot pour la gare 2
    g_babyfoot.append("rect")
    	.attr("id","valeur_babyfoot2")
      .attr("y", y_divertissements)
      .attr("x", x_divertissements2+(i*36)+(i*18))
	  	.style("fill",function(){if(div2[i][1]>0){return "DarkOrange"}
                             else{return "lightgrey"}})
...
function refreshPiano(div1,div2,i){
    ...
    d3.selectAll("#path_piano").attr("transform","scale(0.4) translate("+ d3.select("#valeur_piano2").attr("x")/0.42 +","+d3.select("#valeur_piano").attr("y")/0.4+")")
    
}
function refreshBook(div1,div2,i){
  
  	var g_book = statG.append("g")
...
function refreshVoiture(acc1,acc2,i){
					histo_acces.append("rect")
          					 .attr("id","valeur_voiture")
    								 .attr("y", y_acces)
      							 .attr("x", x_divertissements1+(i*36)+(i*18))
    								 .style("fill",function(){if(acc1[i][1]>0){return "#4d4dff"}
                               else{return "lightgrey"}})
          histo_acces.append("rect")
          					 .attr("id","valeur_voiture2")
    								 .attr("y", y_acces)
      							 .attr("x", x_divertissements2+(i*36)+(i*18))
    								 .style("fill",function(){if(acc2[i][1]>0){return "DarkOrange"}
                               else{return "lightgrey"}})
          
          histo_acces.append("path")
          	 .attr("id","path_voiture")
  					 ...
  					 .style("fill","black")
  					 d3.selectAll("#path_voiture").attr("transform","scale(0.2) translate("+ d3.select("#valeur_voiture").attr("x")/0.199 +","+d3.select("#valeur_voiture").attr("y")/0.198+")")
}
function refreshTaxis(acc1,acc2,i){
					histo_acces.append("rect")
          					 .attr("id","valeur_taxis")
    								 .attr("y", y_acces )
      							 .attr("x", x_divertissements1+(i*36)+(i*18))
    								 .style("fill",function(){if(acc1[i][1]>0){return "#4d4dff"}
                               else{return "lightgrey"}})
          histo_acces.append("rect")
          					 .attr("id","valeur_taxis2")
    								 .attr("y", y_acces)
      							 .attr("x", x_divertissements2+(i*36)+(i*18))
    								 .style("fill",function(){if(acc2[i][1]>0){return "DarkOrange"}
                               else{return "lightgrey"}})
          ...
          histo_acces.append("path")
          	 .attr("id","path_taxis")
  					 ...
  					 .style("fill","black")
  					 d3.selectAll("#path_taxis").attr("transform","scale(0.08) translate("+ d3.select("#valeur_taxis").attr("x")/0.0797 +","+d3.select("#valeur_taxis").attr("y")/0.08+")")
}
function refreshBus(acc1,acc2,i){
          ...
          histo_acces.append("path")
          	 .attr("id","path_bus")
  					 ...
  					 .style("fill","black")
  					 d3.selectAll("#path_bus").attr("transform","scale(0.08) translate("+ d3.select("#valeur_bus").attr("x")/0.0805 +","+d3.select("#valeur_bus").attr("y")/0.08 +")")
}    
    
function refreshMetro(acc1,acc2,i){
					histo_acces.append("rect")
          					 .attr("id","valeur_metro")
    								 .attr("y", y_acces)
      							 .attr("x", x_divertissements1+(i*36)+(i*18))
    								 .style("fill",function(){if(acc1[i][1]>0){return "#4d4dff"}
                               else{return "lightgrey"}})
          histo_acces.append("rect")
          					 .attr("id","valeur_metro2")
    								 .attr("y", y_acces)
      							 .attr("x", x_divertissements2 +(i*36)+(i*18))
    								 .style("fill",function(){if(acc2[i][1]>0){return "DarkOrange"}
                               else{return "lightgrey"}})
          ...
          histo_acces.append("path")
          	 .attr("id","path_metro")
  					 ...
  					 .style("fill","black")
  					 d3.selectAll("#path_metro").attr("transform","scale(0.2) translate("+ d3.select("#valeur_metro").attr("x")/0.199 +","+d3.select("#valeur_metro").attr("y")/0.198+")")
}     
function refreshTram(acc1,acc2,i){
          ...
          histo_acces.append("path")
          	 .attr("id","path_tram")
  					 ...
  					 .style("fill","black")
  					 d3.selectAll("#path_tram").attr("transform","scale(0.2) translate("+ d3.select("#valeur_tram").attr("x")/0.199 +","+d3.select("#valeur_tram").attr("y")/0.198+")")
}
    
function refreshMarche(acc1,acc2,i){
					histo_acces.append("rect")
          					 .attr("id","valeur_marche")
    								 .attr("y", y_acces)
      							 .attr("x", x_divertissements1+(i*36)+(i*18))
    								 .style("fill",function(){if(acc1[i][1]>0){return "#4d4dff"}
                               else{return "lightgrey"}})
          histo_acces.append("rect")
          					 .attr("id","valeur_marche2")
    								 .attr("y", y_acces)
      							 .attr("x", x_divertissements2+(i*36)+(i*18))
    								 .style("fill",function(){if(acc2[i][1]>0){return "DarkOrange"}
                               else{return "lightgrey"}})
          ...
          histo_acces.append("path")
          	 .attr("id","path_marche")
  					 ...
  					 .style("fill","black")
  					 d3.selectAll("#path_marche").attr("transform","scale(0.09) translate("+ d3.select("#valeur_marche").attr("x")/0.091 +","+d3.select("#valeur_marche").attr("y")/0.092+")")
}
...
function refreshVelo(acc1,acc2,i){
          ...
          histo_acces.append("path")
          	 .attr("id","path_velo")
  					 ...
  					 .style("fill","black")
  					 d3.selectAll("#path_velo").attr("transform","scale(0.35) translate("+ d3.select("#valeur_velo").attr("x")/0.35 +","+d3.select("#valeur_velo").attr("y")/0.35+")")
}
...
function refreshMotif(mot1,mot2){
  ...
  var y_motif = d3.scaleLinear()
    	//.range([+d3.select("svg").attr("height")/2,0])
  		.range([max_y,0])
  ...
  var histo_motif = statG.append("g")
  .attr("transform","translate("+25+","+220+")")
  
  var axe_histo_motif = statG.append("g")
  	.attr("transform","translate("+25+","+452+")")
  	.attr('class','x axis')
  	.call(xAxis_motif)
  
  var max1 = d3.max([mot1[1].divers,mot1[1].commute,mot1[1].etudes,mot1[1].loisirs,mot1[1].occasionnel])
  var max2 = d3.max([mot2[1].divers,mot2[1].commute,mot2[1].etudes,mot2[1].loisirs,mot2[1].occasionnel])
  ...
  var axey_histo_motif = statG.append("g")
  	.attr("transform","translate("+25+","+220+")")
  	.attr('class','y axis')
  	.call(yAxis_motif)
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot1[1].divers)})
  					 .attr("width",20)
  					 .style("fill","#4d4dff")
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot1[1].commute)})
  					 .attr("width",20)
  					 .style("fill","#4d4dff")
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot1[1].etudes)})
  					 .attr("width",20)
  					 .style("fill","#4d4dff")
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot1[1].occasionnel)})
  					 .attr("width",20)
  					 .style("fill","#4d4dff")
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot1[1].loisirs)})
  					 .attr("width",20)
  					 .style("fill","#4d4dff")
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot2[1].divers)})
  					 .attr("width",20)
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot2[1].commute)})
  					 .attr("width",20)
  					 .style("fill","DarkOrange")
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot2[1].etudes)})
  					 .attr("width",20)
  					 .style("fill","DarkOrange")
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot2[1].occasionnel)})
  					 .attr("width",20)
  					 .style("fill","DarkOrange")
  ...
  histo_motif.append("rect")
  					 ...
  					 .attr("height",function(){return 232-y_motif(mot2[1].loisirs)})
  					 .attr("width",20)
  					 .style("fill","DarkOrange")
}
